...
use idempotent_ledger_rs::{db::Db, error::LedgerError, ledger::LedgerService, types::{TransferRequest, TransferResult}};
...
async fn balance_handler(
    ...
    Ok(Json(serde_json::json!({ "account_id": id, "balance_cents": balance })))
}
